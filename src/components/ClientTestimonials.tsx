      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map(testimonial => (
            <div key={testimonial.id} className="bg-automato-dark-blue/50 p-6 md:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow border border-automato-gold/20 futuristic-card">
        ...
        <div className="mt-24">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {technologies.map((tech, index) => (
              <div key={index} className="bg-automato-dark-blue/40 px-5 py-3 rounded-lg border border-automato-gold/20 hover:border-automato-gold/40 transition-colors">
