        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/company/flownine" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="h-10 w-10 rounded-full border border-automato-gold/40 flex items-center justify-center hover:bg-automato-gold/10 hover:border-automato-gold transition-colors"
                aria-label="LinkedIn da FlowNine"
              >
                <Linkedin className="h-5 w-5 text-automato-gold" />
              </a>
              
              <a 
                href="https://www.instagram.com/flownine.ai/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="h-10 w-10 rounded-full border border-automato-gold/40 flex items-center justify-center hover:bg-automato-gold/10 hover:border-automato-gold transition-colors"
                aria-label="Instagram da FlowNine"
              >
              ...
              <a 
                href="https://youtube.com/@flownine" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="h-10 w-10 rounded-full border border-automato-gold/40 flex items-center justify-center hover:bg-automato-gold/10 hover:border-automato-gold transition-colors"
                aria-label="YouTube da FlowNine"
              >
                <svg className="h-5 w-5 text-automato-gold" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-white/40 text-xs">CNPJ 45.217.293/0001-00</p>
            </div>
          </div>
        </div>
