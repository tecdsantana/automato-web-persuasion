    ...
    <header className={`w-full py-4 fixed top-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto flex items-center justify-between container-padding">
        ...
        <nav className="hidden md:flex space-x-10">
          ...
          <a href="#solucoes" onClick={(e) => handleNavClick(e, 'solucoes')} className="text-white/80 hover:text-automato-gold transition-colors text-sm tracking-wider">CASES DE SUCESSO</a>
